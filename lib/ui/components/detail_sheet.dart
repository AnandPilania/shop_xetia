                            ...
                            child: Center(
                              child: Swiper(
                                onIndexChanged: ((indexImage) =>
                                    productController
                                        .updateIndexProductPicture(indexImage)),
                                itemCount: productController
                                    .listProduct[indexSwiper].imageUrl.length,
                                itemBuilder: (context, indexImage) {
                                  return Image.network(
                                      productController.listProduct[indexSwiper]
                                          .imageUrl[indexImage],
                                      fit: BoxFit.fill);
                                },
                              ),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                      productController
                                          .listProduct[indexSwiper].productName,
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          for (bool isStarred in List.generate(
                                              5, (i) => i < 4 ? true : false))
                                            Icon(Icons.star,
